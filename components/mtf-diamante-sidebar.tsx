...
import { InboxContextMenu } from "@/components/inbox-context-menu";
...
export function MtfDiamanteSidebar() {
				...
				<SidebarGroup>
					<SidebarGroupContent>
						<SidebarMenu>
													...
													React.useMemo(
														...
														return (
															<SidebarMenuSubItem key={cx.id}>
																<InboxContextMenu
																	inbox={cx}
																	onInboxDeleted={() => { refreshCaixas(); }}
																>
																	<SidebarMenuSubButton
																		href={targetHref}
																		onClick={handleClick}
																		onMouseEnter={handleMouseEnter}
																		className={`text-[0.95rem] py-2 transition-colors ${isActive ? "bg-accent" : "hover:bg-accent"} ${isPending ? "opacity-75" : ""}`}
																	>
																		{isWhatsApp ? (
																...
																{state !== "collapsed" && (
																	<SidebarMenuSubButton
																		...
																		onClick={(e) => {
																			e.preventDefault();
																			startTransition(() => { router.push(`/mtf-diamante/inbox/${cx.id}/campanhas`); });
																		}}
																		onMouseEnter={() => {
											...
											<SidebarMenuSub>
												<SidebarMenuSubItem>
													<SidebarMenuSubButton
														...
														onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/dashboard"); }); }}
														onMouseEnter={() => { try { router.prefetch("/mtf-diamante/dashboard"); } catch {} }}
												...
												<SidebarMenuSubItem>
													<SidebarMenuSubButton
														...
														onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/dashboard/agentes"); }); }}
														onMouseEnter={() => { try { router.prefetch("/mtf-diamante/dashboard/agentes"); } catch {} }}
														className={`text-[0.95rem] py-2 transition-colors hover:bg-accent ${isPending ? "opacity-75" : ""}`}
													>
												...
												<SidebarMenuSubItem>
													<SidebarMenuSubButton
														...
														onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/dashboard/mtf-oab"); }); }}
														onMouseEnter={() => { try { router.prefetch("/mtf-diamante/dashboard/mtf-oab"); } catch {} }}
														className={`text-[0.95rem] py-2 transition-colors hover:bg-accent ${isPending ? "opacity-75" : ""}`}
													>
												...
												<SidebarMenuSubItem>
													<SidebarMenuSubButton
														...
														onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/dashboard/mtf-oab/oab-eval"); }); }}
														onMouseEnter={() => { try { router.prefetch("/mtf-diamante/dashboard/mtf-oab/oab-eval"); } catch {} }}
														className={`text-[0.95rem] py-2 transition-colors hover:bg-accent ${isPending ? "opacity-75" : ""}`}
													>
											...
											<SidebarMenuSub>
												<SidebarMenuSubItem>
													<SidebarMenuSubButton
														...
														onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/capitao"); }); }}
														onMouseEnter={() => { try { router.prefetch("/mtf-diamante/capitao"); } catch {} }}
														className={`text-[0.95rem] py-2 transition-colors hover:bg-accent ${isPending ? "opacity-75" : ""}`}
													>
														<Bot className="text-blue-500" />
												...
												<SidebarMenuSubItem>
													<SidebarMenuSubButton
														...
														onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/capitao/documentos"); }); }}
														onMouseEnter={() => { try { router.prefetch("/mtf-diamante/capitao/documentos"); } catch {} }}
														className={`text-[0.95rem] py-2 transition-colors hover:bg-accent ${isPending ? "opacity-75" : ""}`}
													>
												...
												<SidebarMenuSubItem>
													<SidebarMenuSubButton
														...
														onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/capitao/faqs"); }); }}
														onMouseEnter={() => { try { router.prefetch("/mtf-diamante/capitao/faqs"); } catch {} }}
														className={`text-[0.95rem] py-2 transition-colors hover:bg-accent ${isPending ? "opacity-75" : ""}`}
													>
												...
												<SidebarMenuSubItem>
													<SidebarMenuSubButton
														...
														onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/capitao/intents"); }); }}
														onMouseEnter={() => { try { router.prefetch("/mtf-diamante/capitao/intents"); } catch {} }}
														className={`text-[0.95rem] py-2 transition-colors hover:bg-accent ${isPending ? "opacity-75" : ""}`}
													>
							...
							<SidebarMenuItem>
								<SidebarMenuButton
									onClick={(e) => { e.preventDefault(); startTransition(() => { router.push("/mtf-diamante/leads"); }); }}
									onMouseEnter={() => { try { router.prefetch("/mtf-diamante/leads"); } catch {} }}
...
export default MtfDiamanteSidebar;
