    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${getStatusColor(1 - data.overview.successRate, { warning: 0.05, critical: 0.1 })}`}>
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${getStatusColor(data.overview.avgLatency, { warning: 2500, critical: 5000 })}`}>
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${getStatusColor(data.fallbacks.rate, { warning: 0.1, critical: 0.2 })}`}>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className={`text-xl font-bold ${getStatusColor(data.latency.p95, { warning: 2500, critical: 5000 })}`}>
                {formatLatency(data.latency.p95)}
              </div>
            </div>
            <div>
              <div className="text-sm text-gray-500">P99</div>
              <div className={`text-xl font-bold ${getStatusColor(data.latency.p99, { warning: 5000, critical: 10000 })}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="text-sm text-gray-500 mt-1">
                Cost: ${data.tokens.costUsd.toFixed(4)}
              </div>
            </div>
