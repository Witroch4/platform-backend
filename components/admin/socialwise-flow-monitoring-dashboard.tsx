		...
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">Dashboard de performance e saúde do sistema</p>
				</div>
				...
				<TabsContent value="performance" className="space-y-4">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{metrics.currentLatency.hard}ms</div>
								<Progress
									value={(metrics.currentLatency.hard / SLA_THRESHOLDS.HARD_BAND_MAX_MS) * 100}
									className="mt-2"
								/>
								<p className="text-xs text-muted-foreground mt-1">SLA: {SLA_THRESHOLDS.HARD_BAND_MAX_MS}ms</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{metrics.currentLatency.soft}ms</div>
								<Progress
									value={(metrics.currentLatency.soft / SLA_THRESHOLDS.SOFT_BAND_MAX_MS) * 100}
									className="mt-2"
								/>
								<p className="text-xs text-muted-foreground mt-1">SLA: {SLA_THRESHOLDS.SOFT_BAND_MAX_MS}ms</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{metrics.currentLatency.low}ms</div>
								<Progress
									value={(metrics.currentLatency.low / SLA_THRESHOLDS.LOW_BAND_MAX_MS) * 100}
									className="mt-2"
								/>
								<p className="text-xs text-muted-foreground mt-1">SLA: {SLA_THRESHOLDS.LOW_BAND_MAX_MS}ms</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{metrics.currentLatency.router}ms</div>
								<Progress
									value={(metrics.currentLatency.router / SLA_THRESHOLDS.ROUTER_BAND_MAX_MS) * 100}
									className="mt-2"
								/>
								<p className="text-xs text-muted-foreground mt-1">SLA: {SLA_THRESHOLDS.ROUTER_BAND_MAX_MS}ms</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								...
								<Progress
									...
									className="mt-2"
								/>
								<p className="text-xs text-muted-foreground mt-1">SLA: {SLA_THRESHOLDS.OVERALL_P95_MAX_MS}ms</p>
							</CardContent>
						</Card>
					</div>
				</TabsContent>
						...
						<Card>
							...
							<CardContent>
								...
								<div className="flex items-center mt-2">
									...
									<span className="text-sm text-muted-foreground">Respostas rápidas</span>
								</div>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								...
								<div className="flex items-center mt-2">
									...
									<span className="text-sm text-muted-foreground">Botões contextuais</span>
								</div>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								...
								<div className="flex items-center mt-2">
									...
									<span className="text-sm text-muted-foreground">Tópicos legais</span>
								</div>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								...
								<div className="flex items-center mt-2">
									...
									<span className="text-sm text-muted-foreground">Conversacional</span>
								</div>
							</CardContent>
						</Card>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
						<Card>
							...
							<CardContent>
								...
								<p className="text-xs text-muted-foreground mt-1">SLA: &lt;{SLA_THRESHOLDS.MAX_TIMEOUT_RATE}%</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{metrics.errorRates.json_parse_fail_rate.toFixed(2)}%</div>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								...
								<p className="text-xs text-muted-foreground mt-1">SLA: &lt;{SLA_THRESHOLDS.MAX_ABORT_RATE}%</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								...
								<p className="text-xs text-muted-foreground mt-1">SLA: &lt;{SLA_THRESHOLDS.MAX_ERROR_RATE}%</p>
							</CardContent>
						</Card>
					</div>
				</TabsContent>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
						<Card>
							...
							<CardContent>
								...
								<p className="text-xs text-muted-foreground mt-1">SLA: ≥{SLA_THRESHOLDS.MIN_HARD_ACCURACY}%</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								...
								<p className="text-xs text-muted-foreground mt-1">SLA: ≥{SLA_THRESHOLDS.MIN_SOFT_CTR}%</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								...
								<p className="text-xs text-muted-foreground mt-1">SLA: ≥{SLA_THRESHOLDS.MIN_LOW_VALID_TOPICS}%</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{metrics.qualityMetrics.sample_size}</div>
			...
			<div className="text-center text-sm text-muted-foreground">
				{lastUpdated && <p>Última atualização: {lastUpdated.toLocaleString("pt-BR")}</p>}
				{error && <p className="text-red-600 mt-1">Erro: {error}</p>}
			</div>
		</div>
	);
}
