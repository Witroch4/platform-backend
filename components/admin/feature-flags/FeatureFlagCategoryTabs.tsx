				...
				<CardContent className="p-4">
					<div className="flex items-center gap-4">
						...
						<div className="flex items-center gap-2">
							...
							<Button variant={filterEnabled === null ? "default" : "outline"} onClick={() => setFilterEnabled(null)}>
								Todas
							</Button>
							<Button variant={filterEnabled === true ? "default" : "outline"} onClick={() => setFilterEnabled(true)}>
								Ativas
							</Button>
							<Button variant={filterEnabled === false ? "default" : "outline"} onClick={() => setFilterEnabled(false)}>
								Inativas
							</Button>
						</div>
					</div>
			...
			{categories
				...
				.map((flag) => (
					<div key={`dialogs-${flag.id}`} className="hidden">
						<UserFlagOverrideDialog flagId={flag.id} flagName={flag.name}>
							<div />
						</UserFlagOverrideDialog>

						<FeatureFlagMetricsDashboard flagId={flag.id} flagName={flag.name}>
							<div />
