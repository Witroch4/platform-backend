...
export function FeatureFlagMetricsDashboard({
  flagId,
  flagName,
  children
}: FeatureFlagMetricsDashboardProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-6xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Análise de performance e uso da feature flag "{flagName}"
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {summary.lastEvaluated 
                            ? new Date(summary.lastEvaluated).toLocaleString("pt-BR")
                            : "Nunca"
                          }
                        </p>
                      </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Histórico de avaliações e performance dos últimos 30 dias
                </CardDescription>
              </CardHeader>
              <CardContent>
                {metrics.length === 0 ? (
            ...
            {summary && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Análise automática da performance da feature flag
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    {summary.successRate < 95 && (
                      <div className="flex items-center gap-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                        ...
                        <p className="text-sm text-red-800">
                          Taxa de sucesso baixa ({summary.successRate.toFixed(1)}%). Verifique possíveis erros na configuração.
                        </p>
                      </div>
                    )}
