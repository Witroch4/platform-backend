...
/**
 * Teste simples para ver o erro específico do webhook
 */
...
// Função para criar payload com source_id aleatório
function createTestPayload() {
  ...
  return {
    ...
    "context": {
      "message": {
        ...
        "private": false,
        "status": "sent",
        "source_id": randomWamid, // Source ID aleatório aqui
        "content_type": "text",
        "content_attributes": {},
        "sender_type": "Contact",
        "sender_id": 1447,
        ...
        "processed_message_content": "OLA tudo bem?",
        "sentiment": {}
      },
      "conversation": {
        "id": 2133,
  ...
  console.log('🧪 Teste do webhook com payload completo');
