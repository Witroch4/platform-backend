...
console.log(
	"- Footer:",
	JSON.stringify(converted.footer) === JSON.stringify(expectedWhatsAppFormat.footer) ? "✅" : "❌",
);
console.log(
	"- Action:",
	JSON.stringify(converted.action) === JSON.stringify(expectedWhatsAppFormat.action) ? "✅" : "❌",
);
