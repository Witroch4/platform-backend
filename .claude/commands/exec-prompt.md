...
Siga as instruções do prompt passado entre <instruções></instruções> para
executar as tarefas informadas como argumentos.
...
- Antes de fazer qualquer alteração, siga as diretrizes de engenharia se elas estiverem disponíveis na documentação. Também verifique o arquivo `claude.md e siga estritamente as regras ali descritas.
...
- Ao debuggar, busque identificar a causa raiz em vez de apenas tratar sintomas.
