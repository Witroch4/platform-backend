...
# Global (recomendado)
npx skills add Witroch4/master-front-skill -g

# Ou skill específica
npx skills add Witroch4/master-front-skill@master-front-skill -g
Para atualizar no futuro (quando editar o SKILL.md):


cd /home/wital/agent-skills
cp ~/.claude/skills/master-front-skill/SKILL.md master-front-skill/SKILL.md
git add . && git commit -m "chore: update master-front-skill"
git push
