...
async function testPDF(fileName: string) {
  ...
  try {
    ...
    console.log(`   🎯 PEÇA: ${verificacao.peca.total} pts (esperado: ${verificacao.peca.esperado}, desvio: ${verificacao.peca.desvio})`);
    console.log(`   🎯 QUESTÕES: ${verificacao.questoes.total} pts (esperado: ${verificacao.questoes.esperado}, desvio: ${verificacao.questoes.desvio})`);
    console.log(`   🎯 GERAL: ${verificacao.geral.total} pts (esperado: ${verificacao.geral.esperado}, desvio: ${verificacao.geral.desvio})`);
