			...
			<div className="container mx-auto px-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{socialPlatforms.map((platform, index) => (
						...
						>
							<div
								className={`w-20 h-20 ${platform.gradient} rounded-2xl flex items-center justify-center mx-auto mb-6`}
							>
								{platform.icon}
							</div>
							<h3 className="text-2xl font-bold mb-4 text-center text-gray-900 dark:text-white">{platform.title}</h3>
							<p className="text-gray-600 dark:text-gray-400 text-center mb-6">{platform.description}</p>
