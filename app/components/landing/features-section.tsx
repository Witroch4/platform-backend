...
const features = [
	{
		...
		details: ["Conversas em tempo real", "Geração de imagens", "Transcrição de áudio", "Análise de documentos"],
	...
	},
	{
		...
		details: ["Respostas automáticas", "Chatbots personalizados", "Gestão de leads", "Análise de engajamento"],
	...
	},
	{
		...
		details: ["Gestão de leads OAB", "Agendamento inteligente", "Análise de documentos", "Automação de processos"],
	...
	},
	{
		...
		details: ["PDF para imagens", "Manuscritos automáticos", "Espelhos de correção", "Análise automática"],
			...
			<div className="container mx-auto px-4">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 dark:text-gray-400 max-w-4xl mx-auto">
						Uma plataforma completa que une inteligência artificial, automação de redes sociais e ferramentas
						especializadas para advogados
					</p>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
					{features.map((feature, index) => (
						<div
							key={index}
							className={`${feature.gradient} p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border ${feature.borderColor}`}
						>
