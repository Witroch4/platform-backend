...
export function useOptimisticFileDeletion() {
	 ...
	 */
	const optimisticDeletePdf = useCallback((lead: LeadChatwit, onEdit: (lead: LeadChatwit) => void) => {
		setDeletionState((prev) => ({
	 ...
	 */
	const optimisticDeleteImages = useCallback((lead: LeadChatwit, onEdit: (lead: LeadChatwit) => void) => {
		setDeletionState((prev) => ({
