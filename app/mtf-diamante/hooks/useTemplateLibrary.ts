...
export function useTemplateLibrary(options: UseTemplateLibraryOptions = {}): TemplateLibraryHook {
	...
	const createTemplate = useCallback(
		async (data: Omit<CreateTemplateLibraryData, "createdById">) => {
			setLoading(true);
			setError(null);
	...
	const updateTemplate = useCallback(
		async (id: string, updates: Partial<CreateTemplateLibraryData>) => {
			setLoading(true);
			setError(null);
	...
	const requestApproval = useCallback(
		async (templateId: string, requestMessage?: string, customVariables?: Record<string, string>) => {
			setLoading(true);
			setError(null);
	...
	const useInteractiveMessage = useCallback(
		async (messageId: string, variables: Record<string, string>) => {
			setLoading(true);
			setError(null);
