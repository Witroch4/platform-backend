		...
		<AlertDialog open={open} onOpenChange={onOpenChange}>
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription>
						Todos os nós e conexões serão removidos. Esta ação não pode ser desfeita a menos que você tenha
						salvo anteriormente.
					</AlertDialogDescription>
				</AlertDialogHeader>
				<AlertDialogFooter>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription className="space-y-2">
						...
						<p>
							O sistema irá criar automaticamente os nós e conexões no Flow Builder com base nessas
