		...
		<NodeContextMenu onDuplicate={handleDuplicate}>
			<div
				className={cn(
					...
					selected ? "ring-2 ring-primary ring-offset-2 border-green-500" : "border-green-400 dark:border-green-700",
				)}
			>
				{/* Header */}
				<div className="flex items-center gap-3 px-4 py-3">
					...
					<div className="min-w-0">
						<p className="font-semibold text-sm truncate">{data.label || "Início"}</p>
				...
				<Handle type="source" position={Position.Bottom} className="!h-3 !w-3 !bg-green-500 !border-2 !border-white" />
			</div>
		</NodeContextMenu>
	);
});
