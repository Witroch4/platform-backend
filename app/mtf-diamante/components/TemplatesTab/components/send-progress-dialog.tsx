	...
	return (
		...
		>
			<DialogContent className="max-w-md backdrop-blur-xl bg-background/95 shadow-xl border-primary/20 overflow-hidden">
				<div
					className={`absolute inset-0 bg-gradient-to-r from-green-500/5 via-blue-500/5 to-green-500/5 pointer-events-none ${magicEffect ? "opacity-30" : "opacity-0"} transition-opacity duration-1000`}
				></div>
				...
				<div className="py-6">
					...
					<div className="space-y-2">
						<div className="relative">
							...
							<div
								className={`absolute inset-0 bg-gradient-to-r from-green-500/0 via-green-500/30 to-green-500/0 blur-md ${magicEffect ? "opacity-100" : "opacity-0"} transition-opacity duration-300`}
							></div>
						</div>
						<div className="flex justify-between text-xs text-muted-foreground">
							<p>
								Enviadas: {sentCount} / {numContacts}
							</p>
