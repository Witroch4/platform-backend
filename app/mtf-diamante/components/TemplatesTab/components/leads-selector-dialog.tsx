...
import type { LeadChatwit } from "@/app/mtf-diamante/leads/types";
		...
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="max-w-6xl max-h-[80vh] overflow-hidden flex flex-col">
				...
				<div className="flex-1 overflow-hidden flex flex-col space-y-4">
					...
					<div className="space-y-3">
						...
						<div className="flex items-center gap-2 flex-wrap">
							...
							{/* Botão Este Mês */}
							<Button variant={showThisMonth ? "default" : "outline"} onClick={handleThisMonth} className="h-8 text-xs">
								...
								<Badge variant="secondary" className="text-xs">
									{showThisMonth
										...
										: dateFrom && dateTo
											...
											: dateFrom
												? `A partir de ${format(dateFrom, "dd/MM", { locale: ptBR })}`
										...
										<TableRow key={lead.id}>
											...
											<TableCell>
												<div className="flex items-center gap-2">
													...
													<span className="text-sm">{formatPhoneNumber(lead.phoneNumber || "")}</span>
												</div>
											</TableCell>
											<TableCell>
												<div className="flex items-center gap-2">
											...
											<TableCell>
												<Badge variant={lead.fezRecurso ? "default" : "outline"} className="text-xs">
													{lead.fezRecurso ? "Sim" : "Não"}
												</Badge>
											</TableCell>
											<TableCell>
												<Badge variant={lead.status === "ativo" ? "default" : "secondary"} className="text-xs">
				...
				<DialogFooter>
					...
					<Button onClick={handleConfirm} disabled={selectedLeads.length === 0}>
