...
import type { InteractiveButton, ButtonReaction as LocalButtonReaction } from "../../shared/ButtonManager";
...
export interface UnifiedEditingStepProps {
	...
	onReactionUpdate: (buttonId: string, reaction: Partial<CentralButtonReaction>) => void;
	onNext: () => void;
	onBack: () => void;
	disabled?: boolean;
	className?: string;
