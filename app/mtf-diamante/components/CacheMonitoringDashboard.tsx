				...
				<>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						<Card>
							...
							<CardContent>
								<div className="flex items-center space-x-2">
									...
									<span className="text-sm text-muted-foreground">{cacheData.health.latency}ms</span>
								</div>
								{cacheData.health.memoryUsage && (
									<p className="text-xs text-muted-foreground mt-1">Memory: {cacheData.health.memoryUsage}</p>
								)}
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<div className="flex items-center space-x-2">
									...
									<span className="text-2xl font-bold">{cacheData.performanceStats.hitRate.toFixed(1)}%</span>
								</div>
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{cacheData.performanceStats.averageLatency.toFixed(1)}ms</div>
								<p className="text-xs text-muted-foreground">
