export const socialwiseFacebookPayload = {
	...
	context: {
		...
		"socialwise-chatwit": {
			...
			account_data: { id: 3, name: "DraAmandaSousa" },
			metadata: {
	...
	metadata: { event_name: "message.created", conversation_id: 2214, message_id: 39590, account_id: 3, inbox_id: 106 },
};
