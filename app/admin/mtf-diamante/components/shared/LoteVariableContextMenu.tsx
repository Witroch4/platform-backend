			...
			>
				...
				<CardContent className="p-0">
					<ScrollArea className="h-64">
						{loading ? (
							<div className="p-4 text-center text-sm text-muted-foreground">Carregando lotes...</div>
						) : error ? (
							<div className="p-4 text-center text-sm text-destructive">{error}</div>
						) : filteredLotes.length === 0 ? (
							<div className="p-4 text-center text-sm text-muted-foreground">Nenhum lote encontrado</div>
						) : (
