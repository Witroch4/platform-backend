...
export const EmojiReactionNode = memo(
  ({ id, data, selected }: EmojiReactionNodeProps) => {
    ...
    return (
      <NodeContextMenu onDuplicate={handleDuplicate} onDelete={handleDelete}>
        ...
        <Handle
          ...
          className="!h-3 !w-3 !bg-yellow-500 !border-2 !border-white"
        />
...
export const TextReactionNode = memo(
  ({ id, data, selected }: TextReactionNodeProps) => {
    const { setNodes, setEdges, getNodes } = useReactFlow();
  ...
  return (
    <NodeContextMenu onDuplicate={handleDuplicate} onDelete={handleDelete}>
      ...
      <Handle
        type="target"
        position={Position.Top}
        className="!h-3 !w-3 !bg-orange-500 !border-2 !border-white"
      />
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            {data.targetTeam || 'Para agente humano'}
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <NodeContextMenu onDuplicate={handleDuplicate} onDelete={handleDelete}>
      ...
      <Handle
        type="target"
        position={Position.Top}
        className="!h-3 !w-3 !bg-pink-500 !border-2 !border-white"
      />
...
export const EndConversationNode = memo(
  ({ id, data, selected }: EndConversationNodeProps) => {
    const { setNodes, setEdges, getNodes } = useReactFlow();
      ...
      <NodeContextMenu onDuplicate={handleDuplicate} onDelete={handleDelete}>
        ...
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {data.endMessage || 'Encerrar conversa'}
            </p>
          </div>
        </div>
      </div>
