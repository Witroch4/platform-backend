    ...
    <Card>
      <CardHeader className="pb-4">
        <CardTitle className="text-base flex items-center gap-2">
          {isInstagram && instagramTemplate?.type === 'generic' ? 'Imagem do Carrossel (Opcional)' : 'Header (Optional)'}
      ...
      <CardContent className="space-y-4">
        ...
        {!(isInstagram && isButtonTemplate) && (
          <>
            {(message.header?.type || (isInstagram && instagramTemplate?.type === 'generic' ? "image" : "text")) === "text" ? (
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <MinIOMediaUpload
                  ...
                  maxSizeMB={
                    isInstagram
                      ? message.header?.type === "video" ? 25 : 8
