							...
							<div className="text-muted-foreground">
								<span className="font-medium">
									...
									{instagramTemplate?.type === "quick_replies"
										? MESSAGE_LIMITS.INSTAGRAM_QUICK_REPLIES_MAX_LENGTH
										: instagramTemplate?.type === "button_template"
											? MESSAGE_LIMITS.INSTAGRAM_BUTTON_TEMPLATE_TEXT_MAX_LENGTH
											: instagramTemplate?.type === "generic"
												? MESSAGE_LIMITS.INSTAGRAM_GENERIC_TITLE_MAX_LENGTH
												: "N/A"}{" "}
									caracteres
								</span>
							</div>
							{instagramTemplate?.isOverLimit && <span className="text-red-600 font-medium">Excede limite!</span>}
						</div>
					)}
				</div>
			</CardContent>
