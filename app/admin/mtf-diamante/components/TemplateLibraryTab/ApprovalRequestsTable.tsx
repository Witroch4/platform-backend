	...
	return (
		<>
			<Card>
				<CardHeader>
					<CardTitle>Approval Requests</CardTitle>
					<CardDescription>Review and process template approval requests from users.</CardDescription>
				</CardHeader>
				<CardContent>
					<Table>
						<TableHeader>
			...
			{/* View Request Dialog */}
			<Dialog open={!!selectedRequest && !processingStatus} onOpenChange={(open) => !open && setSelectedRequest(null)}>
				<DialogContent className="max-w-2xl">
					<DialogHeader>
						<DialogTitle>Approval Request Details</DialogTitle>
						<DialogDescription>Review the template approval request details.</DialogDescription>
					</DialogHeader>
			...
			>
				<DialogContent>
					<DialogHeader>
						<DialogTitle>{processingStatus === "approved" ? "Approve" : "Reject"} Template Request</DialogTitle>
						<DialogDescription>
