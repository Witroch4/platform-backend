...
import { Shield, Plus, Edit, Trash2, Globe, User, MessageSquare, FileText, Settings, Users } from "lucide-react";
...
export const LibraryManagementInterface: React.FC<LibraryManagementInterfaceProps> = ({ onCreateGlobal }) => {
	...
	if (!isSuperAdmin) {
		return (
			<Card>
				...
				<CardContent>
					<p className="text-muted-foreground">Esta funcionalidade está disponível apenas para usuários SUPERADMIN.</p>
				</CardContent>
			</Card>
		);
	}
			...
			<div className="flex items-center justify-between">
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<p className="text-muted-foreground">Gerencie templates e mensagens interativas globais</p>
					</div>
				</div>
				...
				<TabsContent value="global" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>Templates disponíveis para todos os usuários</CardDescription>
						</CardHeader>
						<CardContent>
							{globalLoading ? (
									...
									{globalTemplates.map((template) => (
										...
										>
											...
											<div className="flex gap-1 ml-4">
												<Button variant="ghost" size="icon" title="Editar template" className="hover:bg-accent">
				...
				<TabsContent value="account" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>Templates criados por usuários para suas próprias contas</CardDescription>
						</CardHeader>
						<CardContent>
							{accountLoading ? (
								...
								<div className="space-y-3">
									{accountTemplates.map((template) => (
										...
										>
											...
											<div className="flex gap-1 ml-4">
												<Button variant="ghost" size="icon" title="Promover para global" className="hover:bg-accent">
