			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>Demonstra a renderização de variáveis em diferentes modos</CardDescription>
					</CardHeader>
					<CardContent>
						<TemplatePreview
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>Demonstra suporte a imagens e variáveis</CardDescription>
					</CardHeader>
					<CardContent>
						<TemplatePreview
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>Template sem variáveis para teste de compatibilidade</CardDescription>
					</CardHeader>
					<CardContent>
						<TemplatePreview
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>Lista das variáveis usadas nos exemplos</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="space-y-2">
							{mockVariables.map((variable, index) => (
								<div key={index} className="flex justify-between items-center p-2 bg-muted rounded">
									<code className="text-sm font-mono">{`{{${variable.chave}}}`}</code>
									<span className="text-sm text-muted-foreground">{variable.valor}</span>
								</div>
							))}
						</div>
					</CardContent>
				...
				<CardContent className="space-y-4">
					<div>
						...
						<p className="text-sm text-muted-foreground">
							Mostra variáveis no formato numerado (&#123;&#123;1&#125;&#125;, &#123;&#123;2&#125;&#125;) com exemplos
							entre parênteses. Ideal para visualizar como o template será enviado para a API do WhatsApp.
						</p>
					</div>
					<div>
						<h4 className="font-semibold text-blue-600">Modo Interativo</h4>
						<p className="text-sm text-muted-foreground">
							Mostra os valores reais das variáveis substituídos no texto. Ideal para visualizar como a mensagem
							aparecerá para o usuário final.
						</p>
					</div>
				</CardContent>
			</Card>
