        ...
        return (
          <div className="p-4 bg-muted rounded-lg">
            ...
            <div className="bg-background p-3 rounded border space-y-3">
              ...
              {formData.interactiveContent.actionType === 'reply_button' && formData.interactiveContent.actionReplyButton && (
        ...
        return (
          <div className="p-4 bg-muted rounded-lg">
            ...
            <div className="bg-background p-3 rounded border">
              ...
              <div className="text-sm text-muted-foreground">
                Categoria: {formData.whatsappOfficialInfo.category}
              </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Crie um template unificado para mensagens do WhatsApp
            </p>
          </div>
        </div>
            ...
            <CardContent>
                          ...
                          {formData.interactiveContent.actionReplyButton?.buttons.map((button, index) => (
                            <div key={index} className="flex items-center gap-2">
                              ...
                              <Button
                                variant="outline"
                                size="icon"
                                onClick={() => removeReplyButton(index)}
                              >
                                <X className="h-4 w-4" />
                              </Button>
                            </div>
              ...
              {formData.type === TemplateType.WHATSAPP_OFFICIAL && (
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="text-sm text-muted-foreground">
                      <strong>Nota:</strong> Templates oficiais do WhatsApp devem ser criados e aprovados 
                      no Business Manager da Meta antes de serem usados aqui. Este formulário apenas 
                      registra a referência ao template já existente.
                    </div>
                  </div>
                </div>
              )}
