          ...
          return (
            <div className="text-xs text-muted-foreground">
              {template.interactiveContent.header && (
                <div>Header: {template.interactiveContent.header.type}</div>
              )}
              <div className="max-w-[200px] truncate">
                {template.interactiveContent.body.text}
              </div>
            </div>
          );
        }
                        ...
                        <div className="text-xs text-muted-foreground">
                          ...
                          {template.stats.approvalRequestsCount > 0 && (
                            <div className="text-yellow-600">
                              Aprovações: {template.stats.approvalRequestsCount}
                            </div>
                          )}
                        </div>
                      </TableCell>
