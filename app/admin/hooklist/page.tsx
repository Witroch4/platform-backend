...
export default function HookListPage() {
  ...
  const filteredHooks = hooks.filter(hook => {
    ...
    const matchesApp = filterApp === 'all' || 
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Visualização completa de TODOS os hooks do Chatwit (origem completa)
          </p>
        </div>
        ...
        <CardContent className="space-y-4">
          ...
          {lastFetch && (
            <div className="text-sm text-muted-foreground">
              Última atualização: {formatDate(lastFetch)}
            </div>
          )}
        </CardContent>
      </Card>
                  ...
                  <CardHeader>
                    ...
                    <CardDescription>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 text-sm">
                        <span>Usuário: {hook.usuarioName} ({hook.usuarioEmail})</span>
                        <span>Conta: {hook.accountName} (ID: {hook.accountId})</span>
                        <span>Caixa: {hook.inboxName} ({hook.inboxChannel})</span>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="text-sm">{hook.accountName} (ID: {hook.accountId})</p>
                      </div>
                      
                      <div>
                        <Label className="text-sm font-medium">Caixa</Label>
                        <p className="text-sm">{hook.inboxName} ({hook.inboxChannel})</p>
                      </div>
                      
                      <div>
                        <Label className="text-sm font-medium">App</Label>
                        <p className="text-sm">{hook.appName} ({hook.appId})</p>
                      </div>

                      <div>
                        <Label className="text-sm font-medium">Hook Inbox</Label>
                        <p className="text-sm">{hook.hookInboxName} (ID: {hook.hookInboxId})</p>
                      </div>
                      ...
                      <div className="mt-4">
                        ...
                        <ScrollArea className="h-32 w-full border rounded-md p-2">
                          <pre className="text-xs">
                            {JSON.stringify(hook.hookSettings, null, 2)}
                          </pre>
                        </ScrollArea>
                      </div>
                    )}
