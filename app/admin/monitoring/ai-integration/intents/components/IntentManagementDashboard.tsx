								...
								<CardHeader className="pb-3">
									<div className="flex items-center justify-between">
										<div className="flex items-center gap-3">
											...
											<Badge className={getActionTypeBadge(intent.actionType)}>{intent.actionType}</Badge>
								...
								<CardContent>
									<div className="space-y-2">
										...
										<div className="flex items-center gap-4 text-sm text-gray-500">
											...
											{intent.template && <span>Template: {intent.template.name}</span>}
										</div>
									</div>
								</CardContent>
							</Card>
			...
			<Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Tem certeza que deseja deletar a intenção "{intentToDelete?.name}"? Esta ação não pode ser desfeita.
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>
