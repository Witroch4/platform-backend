...
import { AlertTriangle, Bell, Edit, Info, Plus, Settings, Trash2, XCircle } from "lucide-react";
				...
				{formData.channels?.map((channel, index) => (
					<div key={index} className="p-4 border rounded-lg space-y-3">
						<div className="flex items-center justify-between">
							...
							<Button variant="outline" onClick={() => handleRemoveChannel(index)}>
						...
						<CardHeader>
							<div className="flex items-center justify-between">
								...
								<div className="flex items-center space-x-2">
									...
									{rule.queueName && <Badge variant="outline">{rule.queueName}</Badge>}
									<Switch
						...
						<CardContent>
							...
							<div className="flex items-center justify-between">
								...
								<div className="flex space-x-2">
									<Button variant="outline" onClick={() => onTestRule(rule)}>
										Test
									</Button>
									<Button variant="outline" onClick={() => handleEditRule(rule)}>
			...
			<Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
				<DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
					<DialogHeader>
						...
						<DialogDescription>Configure a new alert rule to monitor your queues.</DialogDescription>
					</DialogHeader>
