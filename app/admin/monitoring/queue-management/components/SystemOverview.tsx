...
export function SystemOverview({ 
  ...
  const totalJobs = queues.reduce((sum, queue) => 
    sum + queue.counts.waiting + queue.counts.active + queue.counts.completed + queue.counts.failed + queue.counts.delayed, 0
  );
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            Health Score: {systemHealth.score.toFixed(1)}%
          </p>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-2 text-xs text-muted-foreground">
            CPU: {systemMetrics.system.cpuUsage.toFixed(1)}% | 
            RAM: {formatBytes(systemMetrics.system.memoryUsage)}
          </div>
        </CardContent>
      </Card>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <Progress value={(systemMetrics.system.memoryUsage / (8 * 1024 * 1024 * 1024)) * 100} className="h-2" />
                </div>
                <div>
                  <div className="flex justify-between text-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <Progress value={(systemMetrics.redis.memoryUsage / (2 * 1024 * 1024 * 1024)) * 100} className="h-2" />
                </div>
                <div>
                  <div className="flex justify-between text-sm">
