...
export default function QueueDashboard() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "healthy":
      case "active": return "bg-green-500 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 text-white";
      case "warning": return "bg-yellow-500 hover:bg-yellow-600 dark:bg-yellow-600 dark:hover:bg-yellow-700 text-white";
      case "paused": return "bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white";
      case "critical":
      case "error": return "bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white";
      default: return "bg-muted hover:bg-muted/80 dark:bg-muted dark:hover:bg-muted/60 text-muted-foreground";
    }
  };
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "paused": return <Pause className="h-4 w-4 text-blue-600 dark:text-blue-400" />;
      case "critical":
                  ...
                  <div>
                    ...
                    {(queue.throughput !== undefined || queue.avgProcessingTime !== undefined) && (
                      <div className="flex space-x-4 text-xs text-muted-foreground mt-1">
                        {queue.throughput !== undefined && (
                          <span>Throughput: {queue.throughput}/min</span>
                        )}
