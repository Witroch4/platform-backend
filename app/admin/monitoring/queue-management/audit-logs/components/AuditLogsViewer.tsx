...
export default function AuditLogsViewer() {
  ...
  const getActionBadgeColor = (action: string) => {
    switch (action) {
      case "QUEUE_PAUSED": return "bg-yellow-500";
      case "QUEUE_RESUMED": return "bg-green-500";
      case "QUEUE_RETRY_FAILED": return "bg-blue-500";
      case "QUEUE_CLEANED": return "bg-red-500";
