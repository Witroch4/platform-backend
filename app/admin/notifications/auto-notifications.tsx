...
const AutoNotifications = () => {
	...
	return (
		<Card className="border-border bg-card">
				...
				<div className="space-y-4">
					<div className="flex items-center justify-between p-3 bg-muted/30 rounded-md border border-border">
						<div>
							...
							<p className="text-sm text-muted-foreground">Envia uma mensagem de boas-vindas para todos os usuários</p>
						</div>
					...
					<div className="flex items-center justify-between p-3 bg-muted/30 rounded-md border border-border">
						...
						<Badge
							variant="outline"
							className="border-border bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-400/30"
						>
							Aviso prévio
						</Badge>
					</div>
					...
					<div className="flex items-center justify-between p-3 bg-muted/30 rounded-md border border-border">
						...
						<Badge
							variant="outline"
							className="border-border bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400 dark:border-red-400/30"
						>
							Urgente
						</Badge>
					</div>
					...
					{loading && (
						<div className="mt-4">
							...
							<p className="text-sm text-muted-foreground mt-2 text-center">{progressStatus}</p>
						</div>
					)}
			...
			<CardFooter>
				<Button onClick={handleSendAllNotifications} disabled={loading} className="w-full">
					{loading ? (
						<>
