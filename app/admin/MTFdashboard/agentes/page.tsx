...
export default function MtfAgentsBuilderPage() {
  const { blueprints, isLoading: loadingAgents, createBlueprint, updateBlueprint, deleteBlueprint } = useAgentBlueprints();
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm">
                  <p className="text-muted-foreground">
                    Garantir que o LangGraph consiga executar o parser escolhido evita drifts como arrays na raiz ou botões faltando.
                    Revise o schema configurado para manter compatibilidade com o SocialWise Flow.
                  </p>
