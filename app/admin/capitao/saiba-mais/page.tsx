    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            O que é o IA Capitão?
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-base leading-relaxed">
            O IA Capitão é um assistente inteligente projetado para automatizar e otimizar o atendimento ao cliente. 
            Ele combina inteligência artificial avançada com aprendizado contínuo para oferecer respostas precisas e 
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Siga estes passos para configurar seu primeiro assistente do IA Capitão
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mt-1 mb-3">
                  Configure os detalhes do seu assistente:
                </p>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-sm">
                Cada caixa de entrada pode ter apenas um assistente ativo por vez.
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="bg-amber-50 dark:bg-amber-950/30 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
            ...
            <p className="text-sm text-amber-800 dark:text-amber-200">
              ...
              Inicialmente, ele pode transferir a maioria das conversas para agentes humanos até adquirir 
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Defina como o assistente deve se comportar e responder</p>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Permite que o assistente lembre de interações anteriores</p>
                </div>
              </li>
            </ul>
          </div>
