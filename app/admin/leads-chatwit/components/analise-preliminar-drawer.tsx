							...
							<TabsContent value="cabecalho" className="h-full flex-1 overflow-hidden">
								<Card className="h-full flex flex-col">
									<CardHeader className="pb-2">
										...
										<CardDescription>Dados do examinando e do exame</CardDescription>
									</CardHeader>
									...
									<Card>
										<CardHeader className="flex flex-row items-start justify-between pb-2">
											<div>
												...
												<CardDescription>Pontuação da peça processual</CardDescription>
											</div>
											<Button variant="outline" onClick={addPontoPeca} className="mt-0">
									...
									<Card>
										<CardHeader className="flex flex-row items-start justify-between pb-2">
											<div>
												...
												<CardDescription>Pontuação das questões práticas</CardDescription>
											</div>
											<Button variant="outline" onClick={addPontoQuestao} className="mt-0">
												<Plus className="h-4 w-4 mr-1" />
												Adicionar
											</Button>
										</CardHeader>
							...
							<TabsContent value="conclusao" className="h-full flex-1 overflow-hidden">
								<Card className="h-full flex flex-col">
									<CardHeader className="pb-2">
										...
										<CardDescription>Avaliação final sobre o potencial de recurso</CardDescription>
									</CardHeader>
									...
									<Card>
										<CardHeader className="flex flex-row items-start justify-between pb-2">
											<div>
												...
												<CardDescription>Pontos a serem destacados no recurso</CardDescription>
											</div>
											<Button variant="outline" onClick={addArgumentacao} className="mt-0">
												<Plus className="h-4 w-4 mr-1" />
												Adicionar
											</Button>
										</CardHeader>
					...
					<DrawerFooter className="py-4 border-t sticky bottom-0 bg-background mt-auto">
						<div className="flex flex-row items-center justify-between w-full">
							...
							<div className="flex gap-2">
								<Button onClick={handleSave} disabled={isLoading || isValidating} variant="outline">
									{isLoading ? (
										<>
								...
								<Button onClick={handleValidar} disabled={isValidating || isLoading} variant="default">
									{isValidating ? (
										<>
											<Loader2 className="mr-2 h-4 w-4 animate-spin" />
											Validando...
