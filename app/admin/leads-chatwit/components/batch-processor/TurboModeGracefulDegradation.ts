...
export class TurboModeGracefulDegradation {
  ...
  public handleHighErrorRate(errorCount: number, timeWindow: number): DegradationLevel {
    ...
    const trigger: DegradationTrigger = {
      ...
      autoRecover: true,
      recoveryConditions: [
        'Taxa de erro < 0.1/s por 5 minutos',
   ...
   */
  public handleSystemInstability(reason: string, severity: DegradationTrigger['severity'] = 'medium'): DegradationLevel {
    ...
    const trigger: DegradationTrigger = {
      ...
      recoveryConditions: [
        ...
        'Sem erros críticos por 10 minutos'
      ]
    }
  ...
  public isTurboModeAvailable(): boolean {
    return this.currentLevel.level !== 'disabled' && 
