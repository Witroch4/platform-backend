...
export function LeadsWaitingIndicator({ className = "" }: LeadsWaitingIndicatorProps) {
  ...
  return (
    <div className={`flex items-center gap-1 px-2 py-1 bg-orange-100 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-md text-xs font-medium text-orange-700 dark:text-orange-300 ${className}`}>
