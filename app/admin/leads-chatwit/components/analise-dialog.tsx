			...
			<DialogContent className="max-w-3xl">
						...
						{aguardandoAnalise ? (
							<div className="flex flex-col items-center justify-center py-8">
								...
								{onCancelarAnalise && !isAnaliseValidada && (
									<Button variant="destructive" onClick={handleCancelarAnalise} disabled={isCancelando}>
										{isCancelando ? (
											<>
							...
							<div className="flex flex-col items-center justify-center py-8">
								...
								<Button variant="default" className="mt-4" onClick={handleClose}>
									Fechar e Visualizar
								</Button>
							</div>
						) : analiseUrl ? (
							<div className="space-y-4">
								...
								{argumentacaoUrl && (
									...
									>
										...
										<p className="text-lg font-medium">Argumentação Disponível</p>
										<p className="text-sm text-primary mt-2 flex items-center">
											Clique para abrir o PDF
											<ExternalLink className="ml-1 h-3 w-3" />
										</p>
				...
				<DialogFooter className="flex flex-wrap gap-2 justify-between sm:justify-end">
					<div className="flex flex-wrap gap-2">
						<Button variant="outline" onClick={handleClose} disabled={isSaving || isEnviando || isCancelando}>
							Fechar
						</Button>
