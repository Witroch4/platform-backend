...
import { Loader2, ArrowLeft, User, Mail, Shield, Zap, Settings, Clock, Calendar } from "lucide-react";
	...
	return (
		<div className="container mx-auto py-6 space-y-6">
			...
			<div className="flex items-center gap-3">
				<Button variant="ghost" onClick={() => router.push("/admin/features")} className="p-2">
				...
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<p className="text-muted-foreground">Gerencie todas as features para {user.name || "este usuário"}</p>
					</div>
				</div>
			</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>Configure as funcionalidades do sistema para este usuário</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					...
					<div className="flex items-center justify-between p-4 border rounded-lg">
						...
						<div className="flex items-center gap-2">
							...
							/>
							{updating === "flash-intent" && <Loader2 className="h-4 w-4 animate-spin" />}
						</div>
					</div>
					...
					<div className="flex items-center justify-between p-4 border rounded-lg">
							...
							<div>
								...
								{user.turboModeEnabled && (
									<div className="flex items-center gap-2 mt-1">
										...
										<span className="text-xs text-muted-foreground">Processamento em lote otimizado</span>
									</div>
								)}
							</div>
						</div>
						<div className="flex items-center gap-2">
							...
							/>
							{updating === "turbo-mode" && <Loader2 className="h-4 w-4 animate-spin" />}
						</div>
					</div>
				</CardContent>
			</Card>
