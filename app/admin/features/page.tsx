...
export default function FeatureDashboardPage() {
  ...
  const toggleFeatureFlag = async (flagId: string, enabled: boolean) => {
    try {
      ...
      toast.success(
        enabled 
          ? "Feature flag ativada com sucesso" 
          : "Feature flag desativada com sucesso"
      );
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Configure Respostas Rápidas e Modo Turbo para cada usuário. Clique em um usuário para ver todas as features.
            </CardDescription>
          </div>
