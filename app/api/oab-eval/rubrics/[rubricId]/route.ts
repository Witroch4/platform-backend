...
export async function GET(_request: NextRequest, context: { params: Promise<{ rubricId: string }> }) {
	try {
...
export async function PUT(request: NextRequest, context: { params: Promise<{ rubricId: string }> }) {
	try {
		const { rubricId } = await context.params;
...
export async function DELETE(_request: NextRequest, context: { params: Promise<{ rubricId: string }> }) {
	try {
		const { rubricId } = await context.params;
