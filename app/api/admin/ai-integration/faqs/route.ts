...
export async function GET(request: NextRequest) {
  ...
  const faqs = await prisma.aiFaq.findMany({
    ...
    select: { id: true, question: true, answer: true, status: true, assistantId: true, autoGenerated: true, createdAt: true },
  });
...
export async function PATCH(request: NextRequest) {
  ...
  const faq = await prisma.aiFaq.update({ where: { id }, data: update, select: { id: true, question: true, answer: true, status: true } });
