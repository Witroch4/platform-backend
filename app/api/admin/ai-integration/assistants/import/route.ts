    ...
    if (existing && options.conflictResolution === 'replace') {
      ...
      const updated = await prisma.aiAssistant.update({
        ...
        data: {
          ...
          maxOutputTokens: assistantData.maxOutputTokens ?? 384,
          warmupDeadlineMs: assistantData.warmupDeadlineMs ?? 250,
          hardDeadlineMs: assistantData.hardDeadlineMs ?? 120,
          softDeadlineMs: assistantData.softDeadlineMs ?? 300,
