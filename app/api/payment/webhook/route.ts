		...
		try {
			switch (event.type) {
				case "customer.subscription.created": {
					...
					if (!userId) {
						console.error(
							"customer.subscription.created: userId not found in metadata para subscription:",
							subscription.id,
						);
						break;
					}
				...
				case "customer.subscription.updated": {
					...
					if (!userId) {
						console.error(
							"customer.subscription.updated: userId not found in metadata para subscription:",
							subscription.id,
						);
						break;
					}
				...
				case "customer.subscription.deleted": {
					...
					if (!userId) {
						console.error(
							"customer.subscription.deleted: userId not found in metadata para subscription:",
							subscription.id,
						);
						break;
					}
