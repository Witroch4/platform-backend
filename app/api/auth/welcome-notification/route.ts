...
export async function POST() {
	...
	try {
		...
		const message =
			"Olá! Bem-vindo à plataforma Socialwise Chatwit. Aqui você pode gerenciar suas redes sociais, automatizar interações e muito mais. Explore todas as funcionalidades disponíveis e aproveite ao máximo nossa plataforma!";
