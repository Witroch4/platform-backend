			...
			<div className="max-w-md w-full text-center space-y-6">
				...
				<div className="flex justify-center mb-8">
					<div className="relative w-16 h-16 opacity-60">
						<Image src="/assets/iconssvg/logo_thumbnail_w.svg" alt="Chatwit" fill className="object-contain" priority />
					</div>
				</div>
				...
				<div className="space-y-2">
					...
					<p className="text-muted-foreground text-sm leading-relaxed">
						Encontramos um problema ao carregar esta página. Isso pode acontecer por instabilidade na conexão ou um erro
						temporário.
					</p>
				</div>
