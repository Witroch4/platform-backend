				...
				<div style={{ width: "100%" }} className={!isEditing ? "opacity-70" : ""}>
								...
								<TooltipTrigger asChild>
									<div className="flex items-center space-x-2">
										<Switch
											...
											className={!isEditing ? "cursor-not-allowed" : ""}
										/>
										<Label htmlFor="switchResponderComentario">Responder ao comentário de forma pública</Label>
									</div>
								</TooltipTrigger>
								<TooltipContent>
					...
					<div className="flex items-center space-x-2 mb-4 mt-4">
						<Switch
							...
							className={!isEditing ? "cursor-not-allowed" : ""}
						/>
						<Label htmlFor="switchLive">{isLive ? "Automação Ativa" : "Automação Pausada"}</Label>
					</div>
				</div>
