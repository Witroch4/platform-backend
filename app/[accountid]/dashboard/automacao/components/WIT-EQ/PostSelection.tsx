...
export default function PostSelection({
	...
	const postagensParaExibir =
		selectedPost && !selectedPostInPreview && !anyMediaSelected
							...
							<Dialog open={openDialog} onOpenChange={setOpenDialog}>
								...
								<DialogContent className="sm:max-w-[800px]">
									<DialogHeader>
										...
										<DialogDescription>Escolha a publicação que você deseja monitorar</DialogDescription>
									</DialogHeader>
