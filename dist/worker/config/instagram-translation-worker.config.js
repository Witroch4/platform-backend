...
exports.MONITORING_INTERVALS = exports.RESOURCE_LIMITS = exports.WORKER_METRICS = exports.INSTAGRAM_TRANSLATION_WORKER_CONFIG = void 0;
exports.getInstagramTranslationWorkerConfig = getInstagramTranslationWorkerConfig;
exports.validateWorkerConfig = validateWorkerConfig;
exports.getCurrentWorkerConfig = getCurrentWorkerConfig;
exports.logWorkerConfiguration = logWorkerConfiguration;
/**
 * Default configuration for Instagram Translation Worker
 * Optimized for IO-bound translation tasks with high concurrency
 */
exports.INSTAGRAM_TRANSLATION_WORKER_CONFIG = {
 ...
 */
function getInstagramTranslationWorkerConfig(environment) {
    const baseConfig = { ...exports.INSTAGRAM_TRANSLATION_WORKER_CONFIG };
    switch (environment) {
        case 'development':
            return {
                ...baseConfig,
...
function getCurrentWorkerConfig() {
    ...
    if (!validation.valid) {
        ...
        return exports.INSTAGRAM_TRANSLATION_WORKER_CONFIG;
    }
    return config;
}
/**
 ...
 */
function logWorkerConfiguration(config) {
