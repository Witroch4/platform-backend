                ...
                get: {
                    ...
                    parameters: [
                        ...
                        },
                        {
                            ...
                            schema: { type: 'string', enum: ['all', 'waiting', 'active', 'completed', 'failed', 'delayed'], default: 'all' }
                        },
                        {
                            name: 'page',
                            in: 'query',
                        ...
                        events: {
                            ...
                            items: {
                                ...
                                enum: [
                                    ...
                                    'job.delayed', 'job.retry', 'job.removed',
                                    'queue.paused', 'queue.resumed', 'queue.cleaned', 'queue.drained',
                                    'alert.created', 'alert.resolved', 'metrics.threshold_exceeded'
                                ]
                            },
                            minItems: 1
                        },
