...
exports.monitoredPrisma = exports.MonitoredPrismaClient = exports.connectionPoolMonitor = exports.DEFAULT_POOL_CONFIG = void 0;
exports.getConnectionPoolHealth = getConnectionPoolHealth;
exports.getConnectionPoolStats = getConnectionPoolStats;
exports.recordDatabaseQuery = recordDatabaseQuery;
exports.recordConnectionAcquisition = recordConnectionAcquisition;
...
class ConnectionPoolMonitor {
    ...
    constructor(config = exports.DEFAULT_POOL_CONFIG) {
        this.config = config;
    ...
    recordQuery(queryType, executionTime, success, error) {
    ...
    recordConnectionAcquisition(acquisitionTime) {
    ...
    checkErrorRates() {
        ...
        // Check recent errors
        const recentErrors = this.metrics.errors.filter(error => Date.now() - error.timestamp.getTime() < 300000 // Last 5 minutes
        );
    ...
    checkPoolUtilization() {
        ...
        const estimatedActiveConnections = Math.min(Math.ceil(this.metrics.totalQueries / 1000), this.config.maxConnections);
...
exports.connectionPoolMonitor = new ConnectionPoolMonitor();
// Utility functions for external use
async function getConnectionPoolHealth() {
    return exports.connectionPoolMonitor.getCurrentHealthStatus();
}
function getConnectionPoolStats() {
    return exports.connectionPoolMonitor.getPerformanceStats();
}
function recordDatabaseQuery(queryType, executionTime, success, error) {
    exports.connectionPoolMonitor.recordQuery(queryType, executionTime, success, error);
}
function recordConnectionAcquisition(acquisitionTime) {
    exports.connectionPoolMonitor.recordConnectionAcquisition(acquisitionTime);
}
...
exports.monitoredPrisma = new MonitoredPrismaClient();
...
process.on('SIGTERM', () => {
    ...
    exports.connectionPoolMonitor.shutdown();
});
process.on('SIGINT', () => {
