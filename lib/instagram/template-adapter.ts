 ...
 */
export function convertPrismaTemplateToWhatsApp(templateWithContent: TemplateWithContent): WhatsAppTemplate | null {
 ...
 */
export function convertCompleteMessageMappingToWhatsApp(mapping: CompleteMessageMapping): WhatsAppTemplate | null {
	...
	if (interactiveContent.actionReplyButton?.buttons) {
		try {
			const buttonsData =
				typeof interactiveContent.actionReplyButton.buttons === "string"
