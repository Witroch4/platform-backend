 ...
 */
export function calculateFunnelData(sessions: FlowSessionInput[], flow: RuntimeFlowData): FunnelStep[] {
 ...
 */
function calculateStepCounts(sessions: FlowSessionInput[], funnelNodeIds: string[]): number[] {
