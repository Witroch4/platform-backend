  ...
  try {
    const nowTool = tool(
      ...
      },
      {
        ...
        description: 'Retorna a data e hora atuais com informações detalhadas. Use para planejar atendimentos futuros ou quando precisar de informações temporais.',
        schema: z.object({}).describe('Nenhum parâmetro é necessário. Chama automaticamente para obter data/hora atual.'),
      }
    );
    ...
    const ragTool = tool(
      ...
      },
      {
        ...
        description: 'Busca informações relevantes na base de documentos do cliente usando embedding semântico. Retorna conteúdo específico baseado na consulta.',
        schema: z.object({
