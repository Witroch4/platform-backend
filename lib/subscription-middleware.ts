...
const EXEMPTED_EMAILS = ["amandasousa22.adv@gmail.com", "witalorocha216@gmail.com", "witalo_rocha@outlook.com"];

// Rotas que requerem assinatura ativa
const SUBSCRIPTION_REQUIRED_PATHS = ["/dashboard/automacao", "/dashboard/analytics", "/dashboard/advanced-features"];
...
export async function checkSubscriptionMiddleware(request: NextRequest) {
	...
	const requiresSubscription = SUBSCRIPTION_REQUIRED_PATHS.some((path) => pathname.includes(path));
