...
export async function runLLMWithRetrievalTools(
	...
	const { userId, assistantId, accountId, model = "gpt-4o-mini", temperature = 0.7 } = context;
 ...
 */
export async function enhanceRouterLLMWithRetrieval(originalRouterFunction: Function, ...args: any[]): Promise<any> {
