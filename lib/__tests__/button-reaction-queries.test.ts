...
import {
  ...
  getReactionById,
  getUserReactions,
  getReactionsByButtonIds,
  hasButtonReaction,
  getReactionStats,
  deleteReactionsByButtonIds,
} from '../button-reaction-queries'
...
describe('Button Reaction Queries', () => {
  ...
  describe('getReactionsByMessageId', () => {
    it('should get all reactions for a message', async () => {
      ...
      const result = await getReactionsByMessageId(messageId, userId)
    ...
    it('should include inactive reactions when requested', async () => {
      ...
      await getReactionsByMessageId(messageId, userId, { includeInactive: true })
    ...
    it('should include message data when requested', async () => {
      ...
      await getReactionsByMessageId(messageId, userId, { includeMessage: true })
  ...
  describe('getReactionByButtonId', () => {
    it('should get reaction by button ID', async () => {
      ...
      const result = await getReactionByButtonId(buttonId, userId)
    ...
    it('should return null when reaction not found', async () => {
      ...
      const result = await getReactionByButtonId('nonexistent', userId)
  ...
  describe('getReactionById', () => {
    it('should get reaction by ID', async () => {
      ...
      const result = await getReactionById(reactionId, userId)
  ...
  describe('getUserReactions', () => {
    it('should get user reactions with pagination', async () => {
      ...
      const result = await getUserReactions(userId, { page: 1, limit: 10 })
    ...
    it('should handle pagination correctly', async () => {
      ...
      const result = await getUserReactions(userId, { page: 3, limit: 10 })
  ...
  describe('getReactionsByButtonIds', () => {
    it('should get reactions for multiple button IDs', async () => {
      ...
      const result = await getReactionsByButtonIds(buttonIds, userId)
    ...
    it('should return empty array for empty button IDs', async () => {
      const result = await getReactionsByButtonIds([], userId)
  ...
  describe('hasButtonReaction', () => {
    it('should return true when button has reaction', async () => {
      ...
      const result = await hasButtonReaction(buttonId, userId)
    ...
    it('should include inactive reactions when requested', async () => {
      ...
      await hasButtonReaction(buttonId, userId, true)
  ...
  describe('getReactionStats', () => {
    it('should return reaction statistics', async () => {
      ...
      const result = await getReactionStats(userId)
  ...
  describe('deleteReactionsByButtonIds', () => {
    it('should delete reactions for multiple button IDs', async () => {
      ...
      const result = await deleteReactionsByButtonIds(buttonIds, userId)
    ...
    it('should soft delete when requested', async () => {
      ...
      const result = await deleteReactionsByButtonIds(buttonIds, userId, true)
    ...
    it('should return empty result for empty button IDs', async () => {
      const result = await deleteReactionsByButtonIds([], userId)
