...
function convertRubricToSubitems(rubric: RubricPayload, overrides?: Map<string, number>): Subitem[] {
...
export function buildScoreMap(rubric: RubricPayload, extractedData: RawExtractedData): Map<string, number> {
...
export function verifyRubricTotals(rubric: RubricPayload, overrides?: Map<string, number>) {
	const subitems = convertRubricToSubitems(rubric, overrides);
	return verificarPontuacao(subitems);
}

export function prepareRubricScoring(rubric: RubricPayload, extractedData: RawExtractedData) {
