 ...
 */
export async function checkIntentExists(intentSlug: string, agentId?: string, inboxId?: string): Promise<boolean> {
 ...
 */
async function checkIntentInDatabase(intentSlug: string, agentId?: string, inboxId?: string): Promise<boolean> {
