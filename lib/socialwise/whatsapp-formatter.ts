...
export function buildButtons(
	...
	const { header, footer, enableFallback = true, allowedPayloads, dropInvalidInsteadOfFallback = true } = options;
...
export function createButtonOptions(buttons: Array<{ title: string; intent: string }>): WhatsAppButtonOptions[] {
