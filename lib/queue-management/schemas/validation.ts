...
export const QueueConfigSchema = z.object({
	name: z
		...
		.min(1)
		.max(255)
		.regex(/^[a-zA-Z0-9_-]+$/, "Queue name must contain only alphanumeric characters, underscores, and hyphens"),
...
export const ExportRequestSchema = z.object({
	...
	filters: z.union([JobFiltersSchema, QueueFiltersSchema, AlertFiltersSchema, MetricFiltersSchema]),
