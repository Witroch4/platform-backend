...
export class FeatureFlagManager {
	...
	async isEnabled(flagName: string, userId?: string, inboxId?: string, metadata?: Prisma.JsonValue): Promise<boolean> {
	...
	private async checkRolloutPercentage(flagName: string, percentage: number, identifier: string): Promise<boolean> {
