...
import { verifyTurboModeAccess, verifyFeatureFlagManagementAccess, type RoleVerificationResult } from './role-verification'
    ...
    if (!verification.hasAccess) {
      ...
      return {
        ...
        response: NextResponse.json(
          { error: verification.reason || 'Acesso negado.' },
          { status: 401 }
        ),
        verification
      }
