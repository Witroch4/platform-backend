...
-- CreateEnum
CREATE TYPE "public"."AiIntentOutputFormat" AS ENUM ('JSON', 'AT_SYMBOL');
...
-- CreateTable
CREATE TABLE "public"."IntentHitLog" (
    "id" TEXT NOT NULL,
    "conversationId" TEXT NOT NULL,
    "messageId" TEXT NOT NULL,
    "accountId" TEXT NOT NULL,
    ...
    CONSTRAINT "IntentHitLog_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."AiAgentConfig" (
    "id" TEXT NOT NULL,
    "ownerId" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Capitão',
    "provider" TEXT NOT NULL DEFAULT 'openai',
    "model" TEXT NOT NULL DEFAULT 'gpt-4o-mini',
    "systemPrompt" TEXT,
    "immutableDirectives" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."AiAssistant" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT,
    "productName" TEXT,
    "generateFaqs" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateTable
CREATE TABLE "public"."AiAssistantInbox" (
    "id" TEXT NOT NULL,
    "assistantId" TEXT NOT NULL,
    "inboxDbId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "AiAssistantInbox_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "public"."AiDocument" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "assistantId" TEXT,
    "title" TEXT NOT NULL,
...
CREATE TABLE "public"."AiFaq" (
    ...
    "answer" TEXT,
    "status" "public"."AiFaqStatus" NOT NULL DEFAULT 'PENDING',
...
-- CreateIndex
CREATE UNIQUE INDEX "ApiKey_tokenHash_key" ON "public"."ApiKey"("tokenHash");

-- CreateIndex
CREATE INDEX "ApiKey_ownerId_active_idx" ON "public"."ApiKey"("ownerId", "active");
...
-- CreateIndex
CREATE INDEX "NegativeExample_createdAt_idx" ON "public"."NegativeExample"("createdAt");
...
-- CreateIndex
CREATE UNIQUE INDEX "Intent_slug_key" ON "public"."Intent"("slug");

-- CreateIndex
CREATE INDEX "Intent_accountId_isActive_idx" ON "public"."Intent"("accountId", "isActive");

-- CreateIndex
CREATE INDEX "Intent_slug_idx" ON "public"."Intent"("slug");

-- CreateIndex
CREATE INDEX "LlmAudit_conversationId_createdAt_idx" ON "public"."LlmAudit"("conversationId", "createdAt");

-- CreateIndex
CREATE INDEX "LlmAudit_accountId_createdAt_idx" ON "public"."LlmAudit"("accountId", "createdAt");
...
-- CreateIndex
CREATE INDEX "IntentHitLog_accountId_createdAt_idx" ON "public"."IntentHitLog"("accountId", "createdAt");

-- CreateIndex
CREATE INDEX "IntentHitLog_intentId_idx" ON "public"."IntentHitLog"("intentId");

-- CreateIndex
CREATE INDEX "IntentHitLog_expiresAt_idx" ON "public"."IntentHitLog"("expiresAt");

-- CreateIndex
CREATE INDEX "AiAgentConfig_ownerId_idx" ON "public"."AiAgentConfig"("ownerId");

-- CreateIndex
CREATE UNIQUE INDEX "AiAgentConfig_ownerId_key" ON "public"."AiAgentConfig"("ownerId");

-- CreateIndex
CREATE INDEX "AiAssistant_userId_isActive_idx" ON "public"."AiAssistant"("userId", "isActive");

-- CreateIndex
CREATE UNIQUE INDEX "AiAssistantInbox_assistantId_inboxDbId_key" ON "public"."AiAssistantInbox"("assistantId", "inboxDbId");

-- CreateIndex
CREATE INDEX "AiDocument_userId_assistantId_isActive_idx" ON "public"."AiDocument"("userId", "assistantId", "isActive");
...
-- AddForeignKey
ALTER TABLE "public"."Intent" ADD CONSTRAINT "Intent_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."AiAgentConfig" ADD CONSTRAINT "AiAgentConfig_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AiAssistant" ADD CONSTRAINT "AiAssistant_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AiAssistantInbox" ADD CONSTRAINT "AiAssistantInbox_assistantId_fkey" FOREIGN KEY ("assistantId") REFERENCES "public"."AiAssistant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AiAssistantInbox" ADD CONSTRAINT "AiAssistantInbox_inboxDbId_fkey" FOREIGN KEY ("inboxDbId") REFERENCES "public"."ChatwitInbox"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AiDocument" ADD CONSTRAINT "AiDocument_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AiDocument" ADD CONSTRAINT "AiDocument_assistantId_fkey" FOREIGN KEY ("assistantId") REFERENCES "public"."AiAssistant"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AiFaq" ADD CONSTRAINT "AiFaq_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
