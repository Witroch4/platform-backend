...
module.exports = {
	...
	projects: [
		...
		},
		{
			...
			testMatch: ["<rootDir>/__tests__/frontend/**/*.test.tsx", "<rootDir>/__tests__/frontend/**/*.test.ts"],
			setupFilesAfterEnv: ["<rootDir>/__tests__/setup/jest.setup.ts", "<rootDir>/__tests__/setup/jsdom.setup.ts"],
		},
	],
