...
export async function createChatCompletion(this: { client: OpenAI }, messages: any[], options: ChatOptions = {}) {
	...
	try {
		...
		const isReasoningModel = isOSeriesModel || actualModel.startsWith("gpt-5");
		if (isReasoningModel) {
