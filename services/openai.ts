// services/openai.ts
//biblia app\api\openai-source-test-biblia\route.ts
 ...
 */
export function getOpenAIServiceForServer(apiKey?: string): ServerOpenAIService {
	if (!isServer) {
		throw new Error("getOpenAIServiceForServer só pode ser chamada no lado do servidor.");
	}
